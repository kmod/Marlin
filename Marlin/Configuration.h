...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {119.0,119.0,2020.0,102.0}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {200.0,200.0,6.0,100.0}    // (mm/sec)
